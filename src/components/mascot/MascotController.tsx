...
export function MascotController({
  ...
  useEffect(() => {
    ...
    window.addEventListener('jean:happy', handleCustomHappy)
    return () => window.removeEventListener('jean:happy', handleCustomHappy)
  }, [onHappy])
...
export const triggerJeanHappy = () => {
  window.dispatchEvent(new CustomEvent('jean:happy'))
}
